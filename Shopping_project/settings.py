...
SECRET_KEY = 'django-insecure-*$f%c-fwo2j-)fd99yhn@+@*yy6j3!786@t*h&ou0%rx=3%(2o'
...
MEDIA_URL = '/media/'
#product files
PRODUCT_FILES_ROOT = MEDIA_ROOT / 'product_files'
...
EMAIL_FROM_USER = 'imani95@ethereal.email'
EMAIL_HOST = 'smtp.ethereal.email'
EMAIL_HOST_USER = 'imani95@ethereal.email'
EMAIL_HOST_PASSWORD = 'NThvUkRfwJJbKSpuaj'
EMAIL_USE_TLS = True
EMAIL_PORT = 587